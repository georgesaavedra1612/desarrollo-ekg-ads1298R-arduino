...
const int PIN_START = 4;  // PROBAR CON PIN DIGITAL 45 PARA DISPONER EL PIN 4 A CS DEL SPI MICRO SD  
const int IPIN_DRDY = 5;  // PROBAR CON PIN 46
const int PIN_CS = 53;
...
//const int IPIN_PWDN = 49;   
//const int PIN_CLKSEL = 48; 
const int IPIN_RESET  = 3;
 
const int PIN_START = 20;  // PROBAR CON PIN DIGITAL 45 PARA DISPONER EL PIN 4 A CS DEL SPI MICRO SD  4
const int IPIN_DRDY = 21;  // PROBAR CON PIN 46  5
const int PIN_CS = 10;
