...
const int kPIN_LED = 8;//pin with in-built light - typically 13, 11 for Teensy 2.0. 
...
void setup(){
  ...
  gIDval = adc_rreg(ID); //lower 5 bits of register 0 reveal chip type.. busca en los registros del chip, el Registro Control ID 
  switch (gIDval & B00011111 ) { //least significant bits reports channels.. luego usa sus 5 bits menos significativos para obtener el nº de canales, el resto de bits los omite 
          case  B10000: //16
            gMaxChan = 4; //ads1294
            break;
          case B10001: //17
            gMaxChan = 6; //ads1296
            break; 
          case B10010: //18 .. los 5 bits menos significativos del registro ID para el chip que tenemos es 10010
            gMaxChan = 8; //ads1298
            break;
          case B11110: //30
            gMaxChan = 8; //ads1299
